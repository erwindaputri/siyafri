...
@section('content')
    ...
    @include('pengurus.section.profil')
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card-box tilebox-one">
                        ...
                        <span class="badge badge-danger mr-1"> -29% </span> <span class="text-muted">From previous
                            period</span>
                    </div>
                </div>
                            ...
                            <div class="card-box">
                                ...
                                <div class="inbox-widget slimscroll" style="max-height: 324px;">
                                    <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img
                                                    src="{{ url('public/admin') }}/assets/images/users/avatar-1.jpg"
                                    ...
                                    <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img
                                                    src="{{ url('public/admin') }}/assets/images/users/avatar-2.jpg"
                                                    class="rounded-circle" alt=""></div>
                                    ...
                                    <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img
                                                    src="{{ url('public/admin') }}/assets/images/users/avatar-3.jpg"
                                                    class="rounded-circle" alt=""></div>
                                    ...
                                    <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img
                                                    src="{{ url('public/admin') }}/assets/images/users/avatar-4.jpg"
                                                    class="rounded-circle" alt=""></div>
                                    ...
                                    <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img
                                                    src="{{ url('public/admin') }}/assets/images/users/avatar-5.jpg"
                                                    class="rounded-circle" alt=""></div>
                                    ...
                                    <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img
                                                    src="{{ url('public/admin') }}/assets/images/users/avatar-6.jpg"
                                                    class="rounded-circle" alt=""></div>
                                    ...
                                    <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img
                                                    src="{{ url('public/admin') }}/assets/images/users/avatar-8.jpg"
                                                    class="rounded-circle" alt=""></div>
                                    ...
                                    <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img
                                                    src="{{ url('public/admin') }}/assets/images/users/avatar-9.jpg"
                                                    class="rounded-circle" alt=""></div>
