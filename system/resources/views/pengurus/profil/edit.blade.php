            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        ...
                        <hr>
                        <form action="{{ url('page-update-profil', $profil->id_profil) }}" method="POST"
                ...
                <td> <button class="btn btn-dark float-left" onclick="history.back()"><i class="fa fa-arrow-left"></i>
                        kembali</button></td>
                <br><br>
