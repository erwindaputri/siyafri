    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <h4 class="header-title"> Data pengurus</h4>
                        <hr>
                        <p class="sub-header">
                            ...
                            <tbody>
                                @foreach ($list_pengurus as $pengurus)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $pengurus->username }}</td>
                                        <td class="text-center">
                                            <img src="{{ url("public/$pengurus->foto") }}" width="20%" alt="">
                                        </td>

                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a data-toggle="modal" data-target="#modal-lg-edit{{ $pengurus->id_pengurus }}"
                                                    class="btn btn-warning"><i class="fa fa-edit"></i></a>


                                                @include('admin.utils.delete', [
                                                    'url' => url('pengurus', $pengurus->id_pengurus),
                                                ])
                                            </div>
                                        </td>
                                        <div class="modal fade" id="modal-lg-edit{{ $pengurus->id_pengurus }}">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ url('update-pengurus', $pengurus->id_pengurus) }}"
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <img src="{{ url("public/$pengurus->foto") }}"
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ url('pengurus-store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="card-body">
                            <div class="form-group">
